...
public class RestaurantManagementSystem implements InputRetriever<Integer> {
    ...
    public void run() {
        ...
        while (true) { // Infinite loop, continues until the user exits
            ...
            for (int i =1; i<15;i++) { // Displaying line of asterisks for visual separation
                System.out.print("*-");
            }
            System.out.print("*");
            System.out.println();
            ...
            System.out.print("Enter your choice: "); // choice ask

            int choice = scanner.nextInt(); // Gets user choice
            ...
            switch (choice) { // Performs an action based on the user's choice
                ...
                case 1:
                    ...
                    // Add Menu Item
                    scanner.nextLine(); // Consume the leftover newline from nextInt() again look  here
                ...
                case 5:
                    ...
                    // Exit
                    for (int a=1; a < 45; a++) { // adds 45 blank lines to make it vanish dont forget
                        System.out.println("");
                    }
    ...
    public static void main(String[] args) {
        ...
        ///---------------------------/ // <- Like this
        System.out.println("   Welcome to the sushico!");
